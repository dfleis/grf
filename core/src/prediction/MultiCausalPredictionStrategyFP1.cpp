...
MultiCausalPredictionStrategyFP1::MultiCausalPredictionStrategyFP1(size_t num_treatments,
                                                                   size_t num_outcomes) {
...
size_t MultiCausalPredictionStrategyFP1::prediction_length() const {
    return num_treatments * num_outcomes;
}

std::vector<double> MultiCausalPredictionStrategyFP1::predict(const std::vector<double>& average) const {
 ...
 *
 * The fixed-point method induces rhoi to be of the form
 * rhoi = \xi' psi_{hat{mu}, hat{tau}}(Yi, Wi, Gi)
 *      = psi_1
 * where \xi selects the first K-subvector
 */
std::vector<double> MultiCausalPredictionStrategyFP1::compute_variance(
...
size_t MultiCausalPredictionStrategyFP1::prediction_value_length() const {
  return num_types;
}

PredictionValues MultiCausalPredictionStrategyFP1::precompute_prediction_values(
...
std::vector<std::pair<double, double>> MultiCausalPredictionStrategyFP1::compute_error(
    size_t sample,
    const std::vector<double>& average,
    const PredictionValues& leaf_values,
    const Data& data) const {
