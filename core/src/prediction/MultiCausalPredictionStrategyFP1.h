...
#ifndef GRF_MULTICAUSALPREDICTIONSTRATEGYFP1_H
#define GRF_MULTICAUSALPREDICTIONSTRATEGYFP1_H
 ...
 *
 */
class MultiCausalPredictionStrategyFP1 final: public OptimizedPredictionStrategy {
public:

  MultiCausalPredictionStrategyFP1(size_t num_treatments,
                                   size_t num_outcomes);
...
#endif //GRF_MULTICAUSALPREDICTIONSTRATEGYFP1_H
