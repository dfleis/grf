...
#ifndef GRF_MULTICAUSALRELABELINGSTRATEGYFP2_H
#define GRF_MULTICAUSALRELABELINGSTRATEGYFP2_H
...
public:
  MultiCausalRelabelingStrategyFP2(size_t response_length,
...
#endif //GRF_MULTICAUSALRELABELINGSTRATEGYFP2_H
