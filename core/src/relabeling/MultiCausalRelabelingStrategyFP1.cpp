...
MultiCausalRelabelingStrategyFP1::MultiCausalRelabelingStrategyFP1(size_t response_length,
...
bool MultiCausalRelabelingStrategyFP1::relabel(
...
size_t MultiCausalRelabelingStrategyFP1::get_response_length() const {
