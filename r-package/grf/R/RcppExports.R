...
multi_causal_predict <- function(forest_object, train_matrix, test_matrix, num_outcomes, num_treatments, method_flag, num_threads, estimate_variance) {
    .Call('_grf_multi_causal_predict', PACKAGE = 'grf', forest_object, train_matrix, test_matrix, num_outcomes, num_treatments, method_flag, num_threads, estimate_variance)
}

multi_causal_predict_oob <- function(forest_object, train_matrix, num_outcomes, num_treatments, method_flag, num_threads, estimate_variance) {
    .Call('_grf_multi_causal_predict_oob', PACKAGE = 'grf', forest_object, train_matrix, num_outcomes, num_treatments, method_flag, num_threads, estimate_variance)
}
...
ll_regression_train2 <- function(train_matrix, outcome_index, ll_elnet_alpha, ll_split_lambda, ll_split_weight_penalty, ll_split_variables, ll_split_cutoff, overall_beta, mtry, num_trees, min_node_size, sample_fraction, honesty, honesty_fraction, honesty_prune_leaves, ci_group_size, alpha, imbalance_penalty, thresh, maxit, clusters, samples_per_cluster, num_threads, seed) {
    .Call('_grf_ll_regression_train2', PACKAGE = 'grf', train_matrix, outcome_index, ll_elnet_alpha, ll_split_lambda, ll_split_weight_penalty, ll_split_variables, ll_split_cutoff, overall_beta, mtry, num_trees, min_node_size, sample_fraction, honesty, honesty_fraction, honesty_prune_leaves, ci_group_size, alpha, imbalance_penalty, thresh, maxit, clusters, samples_per_cluster, num_threads, seed)
}
